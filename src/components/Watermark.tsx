  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 p-4 z-10">
      <div className="flex items-center justify-center">
        <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg px-4 py-2 shadow-sm border border-gray-200 dark:border-gray-700">
          <a
            href={githubUrl}
            target="_blank"
